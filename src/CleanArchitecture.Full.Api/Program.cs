...
try
{
    ...
    builder.Services.AddSwaggerGen(c =>
    {
        ...
        {
            Title = "CleanArchitecture.Full API",
            Version = "v1",
            Description = "API REST para gestión de cuentas bancarias con Clean Architecture",
            Contact = new OpenApiContact
            {
                Name = "CleanArchitecture.Full",
    ...
    if (app.Environment.IsDevelopment())
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/swagger/v1/swagger.json", "CleanArchitecture.Full API v1");
